...
def what_input(input_str,input_type):
    """
    ...
    while True:
        ...
        try:
            if input_read in ['chicago','new york city','washington'] and input_type == 1:
                ...
                break
            elif input_read in ['yes' , 'no'] and input_type == 4:
                break
            else:
                if input_type == 1:
...
def get_filters():
    ...
    city = what_input("Would you like to see the data for chicago, new york city or washington?",1)
    # get user input for month (all, january, february, ... , june)
    month = what_input("Which Month (all, january, ... june)?", 2)
    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = what_input("Which day? (all, monday, tuesday, ... sunday)", 3)
    print('-'*80)
...
def raw_data(df):
    """Displays a raw data for a city."""
    count = 0 
    user_input = input('\nDo you want read a five lines in raw data? Enter yes or no.\n')
